---
title: "StatisticalInferenceProject_Part2"
author: "Kieso Jan"
date: "8/21/2021"
output:
...
p = ggplot(data,aes(supp,len)) + theme_bw() 
...
p = ggplot(data,aes(dose,len)) + theme_bw() 
...
For each supplement individually, increase in dosage increases the tooth length. 
Overall, there is no statistical significant difference between orange juice and vitamin C. However, for 0.5 mg/day and 1.0 mg/day dose orange juice gives longer tooth length but for 2.0 mg/day there is no statistically significant difference.
